...
// test data
//var keywordtest = "Police search quarry near York for Claudia Lawrence remains";
...
function sortAlternativeArray(keywords, StringArray, biasSites) {
  ...
  console.log("Article words " + keywords);
  console.log("StringArray " + JSON.stringify(StringArray));
  console.log("biasSites " + biasSites);
  ...
  */
  ...
  console.log("sortorderpre = " + keywordCountArray.toString());


  for (let j = 0; j < keywordCountArray.length; j++ ){
      for (let k = 0; k < keywordCountArray.length - j -1; k++ ){
          if(keywordCountArray[k] > keywordCountArray[k+1]) {
            // ES6 way of swapping array elements
            [keywordCountArray[k + 1], keywordCountArray[k]] = [keywordCountArray[k], keywordCountArray[k + 1]];
            [StringArray[k + 1], StringArray[k]] = [StringArray[k], StringArray[k + 1]];
            [biasSites[k + 1], biasSites[k]] = [biasSites[k], biasSites[k + 1]];
          }
  ...
  biasSitesArray = biasSites;
  console.log("sortorder = " + keywordCountArray.toString());
...
function keywordCount(mainTitle, otherTitle){
    ...
    while(words !== null)
      ...
      console.log("main keywords = " + keywords);
